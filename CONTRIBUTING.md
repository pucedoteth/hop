...
Releases are cut automatically from the `production` branch according to the [release workflow](https://github.com/hop-protocol/hop/blob/develop/.github/workflows/ui-deploy.yml).
